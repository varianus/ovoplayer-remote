...
exports
  ...
  pOnClickGeneric name 'Java_org_varianus_ovoplayer_remote_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_varianus_ovoplayer_remote_Controls_'
  ...
  pOnLostFocus name 'Java_org_varianus_ovoplayer_remote_Controls_pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_org_varianus_ovoplayer_remote_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_varianus_ovoplayer_remote_Controls_'
  ...
  pOnWidgeItemLostFocus name 'Java_org_varianus_ovoplayer_remote_Controls_'
